...
set CURRENT_DIR=%cd%
set CATALINA_HOME=$INSTALL_PATH\apache-tomcat-5.5.23
...
set SERVICE_NAME=Tomcat5Chainedit
...
"%EXECUTABLE%" //US//%SERVICE_NAME% ++JvmOptions "-Djava.io.tmpdir=%CATALINA_BASE%\temp;-XX:MaxPermSize=256m" --JvmMs 128 --JvmMx 512 --StartPath %CATALINA_HOME%\bin
