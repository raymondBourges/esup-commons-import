 ...
 */
package org.esupportail.blankpf.web.controllers;

import org.esupportail.blankpf.domain.DomainService;
...
public abstract class AbstractDomainAwareBean extends AbstractJsfMessagesAwareBean implements Resettable {
	...
	/**
	 * @see org.esupportail.blankpf.commons.web.controllers.Resettable#reset()
	 */
	public void reset() {
		// nothing to reset
