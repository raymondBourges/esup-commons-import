...
public abstract class AbstractContextAwareController extends AbstractDomainAwareBean {
	...
	/**
	 * @see org.esupportail.todolist.web.controllers.AbstractDomainAwareBean#afterPropertiesSetInternal()
	 */
	@Override
	...
	/**
	 * @see org.esupportail.todolist.web.controllers.AbstractDomainAwareBean#getCurrentUser()
	 */
	@Override
